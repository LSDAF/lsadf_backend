...
public record UserResponse(
    @JsonProperty(value = JsonAttributes.ID)
        ...
        String id,
    @JsonProperty(value = FIRST_NAME) @Schema(description = "First name", example = "Toto")
        String firstName,
    @JsonProperty(value = LAST_NAME) @Schema(description = "Last name", example = "TUTU")
        String lastName,
    @JsonProperty(value = USERNAME)
        @Schema(description = "User username", example = "toto@toto.com")
        String username,
    @JsonProperty(value = ENABLED) @Schema(description = "User enabled", example = "true")
        Boolean enabled,
    @JsonProperty(value = EMAIL_VERIFIED) @Schema(description = "Email verified", example = "true")
        Boolean emailVerified,
    @JsonProperty(value = USER_ROLES) @Schema(description = "User roles", example = "[\"USER\"]")
