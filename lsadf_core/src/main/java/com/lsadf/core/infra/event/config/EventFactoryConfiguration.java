...
public class EventFactoryConfiguration {
  @Bean
  public InventoryEventFactory inventoryEventFactory(ClockService clockService) {
    return new InventoryEventFactory(clockService);
  }

  @Bean
  public GameMailEventFactory gameMailEventFactory(ClockService clockService) {
    return new GameMailEventFactory(clockService);
  }
}
