...
public final class JsonAttributes {
  ...
  public static final String CLIENT_ID_CAMEL_CASE = "clientId";
  public static final String BLUEPRINT_ID = "blueprint_id";
  public static final String BLUEPRINT_ID_CAMEL_CASE = "blueprintId";
  public static final String RARITY = "rarity";
  public static final String IS_EQUIPPED = "is_equipped";
  public static final String IS_EQUIPPED_CAMEL_CASE = "isEquipped";
  public static final String LEVEL = "level";
  public static final String MAIN_STAT = "main_stat";
  public static final String MAIN_STAT_CAMEL_CASE = "mainStat";
  public static final String ADDITIONAL_STATS = "additional_stats";
  public static final String ADDITIONAL_STATS_CAMEL_CASE = "additionalStats";
  public static final String STATISTIC = "statistic";
  public static final String BASE_VALUE = "base_value";
  public static final String BASE_VALUE_CAMEL_CASE = "baseValue";
