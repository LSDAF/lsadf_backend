 ...
 */
package com.lsadf.core.infra.web.dto.request.common;
 ...
 *
 * <p>Annotations: - {@link Builder}: Enables builder pattern for this class. - {@link Schema}:
 * Describes schema details for documentation.
 *
...
public record Filter(
    @Schema(description = "Type of filter", example = "name") @NotNull String type,
    @Schema(description = "Value of filter", example = "toto") @NotNull String value)
