...
public interface GameSessionCommandService {
  GameSession initializeGameSession(InitializeSessionCommand command);

  GameSession updateGameSessionEndTime(UpdateSessionEndTimeCommand command);
}
