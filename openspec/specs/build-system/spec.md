...
This specification defines the build system requirements for the LSADF Backend project, including Java version, Maven
configuration, Docker base images, and plugin compatibility. The build system ensures consistent compilation, testing,
and packaging across all modules using Java 25 LTS with Spring Boot 3.5.6.
