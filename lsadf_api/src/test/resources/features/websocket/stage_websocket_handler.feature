...
Feature: Stage WebSocket Handler BDD tests
  ...
  Scenario: A user updates stage through WebSocket with cache
    ...
    And the following stage entries in cache
      ...
      | f81b710d-3e02-4871-a86f-390377798dd1 | 5            | 10       | 1    |
    ...
    And the user sends a stage update event through WebSocket
    ...
    And the following stage entries in cache
      | gameSaveId                           | currentStage | maxStage | wave |
      | f81b710d-3e02-4871-a86f-390377798dd1 | 15           | 20       | 3    |

  Scenario: A user updates stage through WebSocket without cache
    Given the following game saves
      | id                                   | userEmail           | gold    | diamond | emerald | amethyst | maxStage | currentStage | wave | attack | critChance | critDamage | health | resistance |
      | f81b710d-3e02-4871-a86f-390377798dd1 | paul.ochon@test.com | 5630280 | 5630280 | 5630280 | 5630280  | 10       | 10           | 2    | 1100   | 1200       | 1300       | 1400   | 1500       |
    And the following game sessions
  ...
  Scenario: A user tries to update stage with invalid session id
    Given the following game saves
      | id                                   | userEmail           | gold    | diamond | emerald | amethyst | maxStage | currentStage | wave | attack | critChance | critDamage | health | resistance |
      | f81b710d-3e02-4871-a86f-390377798dd1 | paul.ochon@test.com | 5630280 | 5630280 | 5630280 | 5630280  | 10       | 10           | 2    | 1100   | 1200       | 1300       | 1400   | 1500       |
    And the following game sessions
  ...
  Scenario: A user updates stage with invalid data through WebSocket
    Given the following game saves
      | id                                   | userEmail           | gold    | diamond | emerald | amethyst | maxStage | currentStage | wave | attack | critChance | critDamage | health | resistance |
      | f81b710d-3e02-4871-a86f-390377798dd1 | paul.ochon@test.com | 5630280 | 5630280 | 5630280 | 5630280  | 10       | 10           | 2    | 1100   | 1200       | 1300       | 1400   | 1500       |
    And the following stage entries in cache
