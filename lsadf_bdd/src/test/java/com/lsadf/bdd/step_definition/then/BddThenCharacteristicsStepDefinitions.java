...
@Slf4j(topic = "[CHARACTERISTICS THEN STEP DEFINITIONS]")
@Component
public class BddThenCharacteristicsStepDefinitions {

  CharacteristicsResponseMapper characteristicsResponseMapper =
      Mappers.getMapper(CharacteristicsResponseMapper.class);
